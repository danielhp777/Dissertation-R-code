...
library(ggplot2)
#library(reticulate)
#use_python("C:/Users/danie/AppData/Local/Programs/Python/Python311/python.exe", required = TRUE)
...
mse <- mean((prediction - hiv_train_y)^2) # approx 3.1
...
# compare with real training responses
mse2 <- mean((prediction2 - hiv_train_y)^2) # approx 2.23
...
# compare with real training responses
mse3 <- mean((prediction3 - hiv_train_y)^2) # approx 2.57
...
# compare with real training responses
mse4 <- mean((prediction4 - hiv_train_y)^2) # approx 2.13
...
# compare with real training responses
mse5 <- mean((prediction5 - hiv_train_y)^2) # approx 2.397, keep dense units at 32
